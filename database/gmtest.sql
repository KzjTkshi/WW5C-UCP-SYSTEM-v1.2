...
CREATE TABLE `survivors` (
  ...
  `Guns` int(6) NOT NULL DEFAULT 0,
  `Ammo` int(6) NOT NULL DEFAULT 0
...
INSERT INTO `survivors` (`pID`, `Name`, `UCP`, `Age`, `Origin`, `Gender`, `AdminLevel`, `Money`, `Guns`, `Ammo`) VALUES
(12, 'Takashi', 'Kazuji_Takashi', 21, 'Indonesia', 0, 7, 0, 0, 0),
(13, 'Health - $50,00', 'Takashi', 21, 'Indonesia', 0, 7, 0, 0, 0);
